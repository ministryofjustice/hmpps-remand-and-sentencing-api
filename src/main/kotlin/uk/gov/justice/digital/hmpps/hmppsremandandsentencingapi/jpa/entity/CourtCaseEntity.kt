  ...
  classes = [
    ConstructorResult(
      ...
      columns = arrayOf(
        ...
        ColumnResult(name = "nextCourtAppearanceSubtypeDescription"),
        ...
        ColumnResult(name = "chargeAggravatingFactorDisplayOrder"),
        ...
        ColumnResult(name = "mergedFromAppearanceUuid"),
        ...
        ColumnResult(name = "mergedToAppearanceUuid"),
