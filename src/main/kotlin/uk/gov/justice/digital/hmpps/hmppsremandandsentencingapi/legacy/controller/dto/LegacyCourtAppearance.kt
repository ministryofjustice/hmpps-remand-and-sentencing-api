...
data class LegacyCourtAppearance(
  ...
  companion object {
    ...
    fun from(courtAppearanceEntity: CourtAppearanceEntity, appearanceTypeUuid: UUID, nomisAppearanceTypeCode: String): LegacyCourtAppearance = LegacyCourtAppearance(
