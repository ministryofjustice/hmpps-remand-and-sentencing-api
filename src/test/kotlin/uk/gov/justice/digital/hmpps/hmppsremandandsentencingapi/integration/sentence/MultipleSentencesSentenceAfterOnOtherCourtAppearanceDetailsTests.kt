...
class MultipleSentencesSentenceAfterOnOtherCourtAppearanceDetailsTests : IntegrationTestBase() {
  ...
  fun `return appearance details of other appearance`() {
    ...
    webTestClient
      .get()
      .uri {
        it.path("/sentence/sentences-after-on-other-court-appearance-details")
