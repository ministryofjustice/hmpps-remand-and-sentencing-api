...
class UpdateCourtCaseTests : IntegrationTestBase() {
  ...
  fun `delete an appearance if emitted from list of appearances`() {
    ...
    val appearance = CreateCourtAppearance(null, UUID.randomUUID(), UUID.randomUUID(), UUID.fromString("62412083-9892-48c9-bf01-7864af4a8b3c"), "COURT1", "COURTREF1", LocalDate.now(), null, "REMAND", 1, null, null, listOf(charge), null, null)
    val secondAppearance = CreateCourtAppearance(null, UUID.randomUUID(), UUID.randomUUID(), UUID.fromString("62412083-9892-48c9-bf01-7864af4a8b3c"), "COURT1", "COURTREF1", LocalDate.now().minusDays(7L), null, "REMAND", 1, null, null, listOf(charge), LocalDate.now().minusDays(7), null)
