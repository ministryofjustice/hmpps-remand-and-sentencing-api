...
class CreateCourtAppearanceTests : IntegrationTestBase() {
  ...
  fun `create appearance in existing court case`() {
    ...
    val appearance = CreateCourtAppearance(courtCase.first, UUID.randomUUID(), UUID.fromString("62412083-9892-48c9-bf01-7864af4a8b3c"), "COURT1", "GH123456789", LocalDate.now(), null, "REMAND", 1, null, null, listOf(charge), LocalDate.now().minusDays(7), null)
    webTestClient
      .post()
  ...
  fun `create appearance with consecutive to sentences`() {
    ...
    val forthWithCharge = CreateCharge(UUID.randomUUID(), "OFF123", LocalDate.now(), null, UUID.fromString("f17328cf-ceaa-43c2-930a-26cf74480e18"), true, forthWithSentence)
    ...
    val concurrentCharge = CreateCharge(UUID.randomUUID(), "OFF123", LocalDate.now(), null, UUID.fromString("f17328cf-ceaa-43c2-930a-26cf74480e18"), true, concurrentSentence)
    ...
    val consecutiveToCharge = CreateCharge(UUID.randomUUID(), "OFF123", LocalDate.now(), null, UUID.fromString("f17328cf-ceaa-43c2-930a-26cf74480e18"), true, consecutiveToSentence)
