 ...
 * and compare with the src/test/resources/sar/alldata/sar-api-response.json
 * ```bash
 * SAR_GENERATE_ACTUAL=true ./gradlew test \
 *  --tests "uk.gov.justice.digital.hmpps.hmppsremandandsentencingapi.integration.subjectaccessrequest.alldata.SarIntegrationTests.SAR API should return expected data"
 * ```
 */
