...
class SentenceEntityTests {
  ...
  fun `can handle comparing null fine amount to actual fine amount`() {
    ...
    val sentenceType = SentenceTypeEntity(sentenceTypeUuid = UUID.randomUUID(), description = "fine", minAgeInclusive = null, maxAgeExclusive = null, minDateInclusive = null, maxDateExclusive = null, minOffenceDateInclusive = null, maxOffenceDateExclusive = null, classification = SentenceTypeClassification.FINE, hintText = null, nomisCjaCode = "", nomisSentenceCalcType = "", displayOrder = 1, status = ReferenceEntityStatus.ACTIVE)
