...
class UnsyncedPrisonerDetailsServiceTests {
  ...
  private val immigrationDetentionRepository = mockk<ImmigrationDetentionSarRepository>()
  ...
  fun `should return all Immigration Detention Prisoner Details`() {
    every { immigrationDetentionRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "asdasdas", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionSarEntity(456, "44959", LocalDate.of(2026, 12, 19), "asdasdas", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
    )
    every { courtCaseSarRepository.existsByPrisonerId("44959") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionRepository, courtCaseSarRepository)
  ...
  fun `should return all Immigration Detention Prisoner Details from date`() {
    every { immigrationDetentionRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "124222111", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionSarEntity(456, "44959", LocalDate.of(2026, 12, 19), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
    )
    every { courtCaseSarRepository.existsByPrisonerId("44959") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionRepository, courtCaseSarRepository)
  ...
  fun `should return all Immigration Detention Prisoner Details from date to date`() {
    every { immigrationDetentionRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "124222111", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionSarEntity(456, "44959", LocalDate.of(2026, 11, 10), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
      ImmigrationDetentionSarEntity(456, "44959", LocalDate.of(2026, 12, 19), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "dolor sit amet"),
    )
    every { courtCaseSarRepository.existsByPrisonerId("44959") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionRepository, courtCaseSarRepository)
  ...
  fun `should return empty when Immigration Detention Prisoner Details not found`() {
    every { immigrationDetentionRepository.findImmigrationDetentionSarEntitiesByPrisonerId(eq("23456")) } returns listOf()
    every { courtCaseSarRepository.existsByPrisonerId(eq("23456")) } returns false
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionRepository, courtCaseSarRepository)
  ...
  fun `should find prisoner id in at least one court case`() {
    every { immigrationDetentionRepository.findImmigrationDetentionSarEntitiesByPrisonerId("4454") } returns listOf()
    every { courtCaseSarRepository.existsByPrisonerId("4454") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionRepository, courtCaseSarRepository)
