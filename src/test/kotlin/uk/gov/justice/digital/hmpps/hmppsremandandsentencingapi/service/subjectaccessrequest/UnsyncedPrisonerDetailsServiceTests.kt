...
class UnsyncedPrisonerDetailsServiceTests {
  ...
  fun `should return all Immigration Detention Prisoner Details`() {
    every { immigrationDetentionUnsyncedRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionUnsyncedSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "asdasdas", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionUnsyncedSarEntity(456, "44959", LocalDate.of(2026, 12, 19), "asdasdas", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
    )
  ...
  fun `should return all Immigration Detention Prisoner Details from date`() {
    every { immigrationDetentionUnsyncedRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionUnsyncedSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "124222111", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionUnsyncedSarEntity(456, "44959", LocalDate.of(2026, 12, 19), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
    )
    every { courtCaseUnsyncedSarRepository.existsByPrisonerId("44959") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionUnsyncedRepository, courtCaseUnsyncedSarRepository)
  ...
  fun `should return all Immigration Detention Prisoner Details from date to date`() {
    every { immigrationDetentionUnsyncedRepository.findImmigrationDetentionSarEntitiesByPrisonerId("44959") } returns listOf(
      ImmigrationDetentionUnsyncedSarEntity(34, "44959", LocalDate.of(2020, 1, 1), "124222111", ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, ""),
      ImmigrationDetentionUnsyncedSarEntity(456, "44959", LocalDate.of(2026, 11, 10), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "Lorem ipsum"),
      ImmigrationDetentionUnsyncedSarEntity(456, "44959", LocalDate.of(2026, 12, 19), null, ImmigrationDetentionNoLongerOfInterestType.BRITISH_CITIZEN, "dolor sit amet"),
    )
    every { courtCaseUnsyncedSarRepository.existsByPrisonerId("44959") } returns true
    val service = UnsyncedPrisonerDetailsService(immigrationDetentionUnsyncedRepository, courtCaseUnsyncedSarRepository)
