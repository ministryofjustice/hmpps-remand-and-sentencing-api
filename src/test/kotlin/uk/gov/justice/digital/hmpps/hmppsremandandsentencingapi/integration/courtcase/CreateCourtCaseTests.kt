...
class CreateCourtCaseTests : IntegrationTestBase() {
  ...
  fun `Successfully create court case`() {
    ...
    val appearance = CreateCourtAppearance(null, UUID.randomUUID(), UUID.fromString("62412083-9892-48c9-bf01-7864af4a8b3c"), "COURT1", "GH123456789", LocalDate.now(), null, "REMAND", 1, null, null, listOf(charge), LocalDate.now().minusDays(7))
  ...
  fun `no token results in unauthorized`() {
    ...
    val appearance = CreateCourtAppearance(null, UUID.randomUUID(), UUID.fromString("62412083-9892-48c9-bf01-7864af4a8b3c"), "COURT1", "GH123456789", LocalDate.now(), null, "REMAND", 1, null, null, listOf(charge), null)
    val courtCase = CreateCourtCase("PRI123", listOf(appearance))
    webTestClient
      .post()
      .uri("/court-case")
