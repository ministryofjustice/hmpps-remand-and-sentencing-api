...
class DataCreator {
  companion object Factory {
    ...
    fun courtAppearanceLegacyData(
      ...
      nextEventDateTime: LocalDateTime? = LocalDateTime.now().plusDays(10).withHour(10).withMinute(0).withSecond(0).truncatedTo(ChronoUnit.SECONDS),
      appearanceTime: LocalTime = LocalTime.of(10, 0, 0).truncatedTo(ChronoUnit.SECONDS),
    ...
    ): LegacyUpdateCharge = LegacyUpdateCharge(offenceStartDate, offenceEndDate, legacyData, performedByUser, offenceCode)
