FROM --platform=$BUILDPLATFORM eclipse-temurin:25.0.4_7-jre-jammy AS builder

ARG BUILD_NUMBER
ENV BUILD_NUMBER=${BUILD_NUMBER:-1_0_0}

WORKDIR /builder
COPY hmpps-remand-and-sentencing-api-${BUILD_NUMBER}.jar app.jar
...
ENTRYPOINT ["java", "-XX:+UseContainerSupport", "-XX:+AlwaysActAsServerClassMachine", "-javaagent:agent.jar", "-jar", "app.jar"]
